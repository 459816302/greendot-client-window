...
namespace ShadowSocks.Util
{
    public class Request
    {
        ...
        private static int REQUEST_TIMES = 1;

        private static string[] CONF_URLS = {
            "https://gitee.com/mcmurphy/greendot/raw/master/api",
            "https://gitlab.com/togayther/greendot-config/raw/master/api"
        };
        ...
        private JObject post_result = null;
        ...
        public async Task Post(string url, List<KeyValuePair<string, string>> data = null)
        {
            ...
            for (int i = 0; i < REQUEST_TIMES; i++)
            {
                try
                {
                    ...
                    HttpResponseMessage response = await client.PostAsync(ServerRoot + url, postData);
